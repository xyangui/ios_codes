...
//Optional类型
let possibleString: String? = "An optional string."//它可能为String，也可能为nil，声明了一个Optional类型，而不是声明了一个String类型。

var strValue: String?   //声明为Optional类型，默认值为nil。判断一个Optional的值是否有值，可以用if来判断：
strValue = "Hello, name"
if (strValue != nil) {
